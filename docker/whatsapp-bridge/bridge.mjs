/**
 * WhatsApp bridge (Baileys) — salinan deploy dari arumanis/scripts/whatsapp-bridge.mjs
 * Canonical source: https://github.com/ilhamtaufiq/arumanis/blob/dev/scripts/whatsapp-bridge.mjs
 */
